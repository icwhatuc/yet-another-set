...
Game.prototype.userCount = function()
{
...
Game.prototype.addPoint = function(user) {
    this._users[user.name()].addPoint();
}

Game.prototype.printPoints = function() {
    console.log("CURRENT SCORE: ");
    for(var name in this._users)
    {
        console.log(name + " " + this._users[name]._totalPoints);
    }
}
